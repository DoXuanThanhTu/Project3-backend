...
exports.ViewCounterModel = void 0;
// models/viewCounter.model.ts
const mongoose_1 = require("mongoose");
const ViewCounterSchema = new mongoose_1.Schema({
...
ViewCounterSchema.index({ movieId: 1, episodeId: 1, date: 1 }, { unique: true });
...
exports.ViewCounterModel = (0, mongoose_1.model)("ViewCounter", ViewCounterSchema);
